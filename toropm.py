...
If someone asks you for a copy of this program, PLEASE direct them
to request it from a channel op on #ratbox on EFnet.
...
class TorBot(SingleServerIRCBot):
    def __init__(self, channel, nickname, server, port=6667):
        SingleServerIRCBot.__init__(self, [(server, port)], nickname, "Onion Router Ban Hammer")
                                ...
                                def known_node(self, c, ip):
                                    ...
                                    def whitelisted_address(self, c, ip):
                                        ...
                                        def banish_list(self, c, e):
                                            ...
                                            ''' we should report these to #bopm, however it's quite noisy
                                            because it repeats itself every 'action_delay' seconds.
                                            so, unless someone requests that feature, we will error on the side
                                            of silence. '''
